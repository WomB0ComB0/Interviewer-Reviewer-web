    ...
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-card-header">
          <h1 className="auth-card-header-text">Interviewer Reviewer</h1>
        </div>
        <div className="auth-card-body">
          <div className="auth-card-body-content">
            <div className="auth-card-body-content-header">
              <h1 className="auth-card-body-content-header-text">Sign Up</h1>
            </div>
            <div className="auth-card-body-content-body">
              <form
                autoComplete=""
                className="auth-card-body-content-body-form"
              >
                <div className="auth-card-body-content-body-form-group">
                  <label
                    htmlFor="email"
                    className="auth-card-body-content-body-form-group-label"
                  >
                    Email
                  </label>
                  <input
                    ...
                    name="email"
                    id="email"
                    className="auth-card-body-content-body-form-group-input"
                  />
                </div>
                <div className="auth-card-body-content-body-form-group">
                  <label
